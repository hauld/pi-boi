...
export class CustomProviderCard extends LitElement {
	@property({ type: Object }) declare provider: CustomProvider;
	@property({ type: Boolean }) declare isAutoDiscovery: boolean;
	@property({ type: Object }) declare status: { modelCount: number; status: "connected" | "disconnected" | "checking" } | undefined;
	@property() declare onRefresh: ((provider: CustomProvider) => void) | undefined;
	@property() declare onEdit: ((provider: CustomProvider) => void) | undefined;
	@property() declare onDelete: ((provider: CustomProvider) => void) | undefined;
